$(function () {
    ...
    var modalInputRoleOptions = {
        backdrop: false,
        keyboard:false
    };
    var modalInputRole = new bootstrap.Modal(
        document.getElementById("modalFormInputRole"),
        modalInputRoleOptions
    );
    ...
    var modalInputPermissionOptions = {
        backdrop: false,
        keyboard:false
    };
    var modalInputPermission = new bootstrap.Modal(
        document.getElementById("modalFormInputPermission"),
        modalInputPermissionOptions
    );

    function openFormPermission() {
        modalInputPermission.show();
    }
